...
var j,k,l="3.7.0",m=a.html5||{},n=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,o=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,p="_html5shiv",q=0,r={};!function(){try{var a=b.createElement("a");a.innerHTML="<xyz></xyz>",j="hidden"in a,k=1==a.childNodes.length||function(){b.createElement("a");var a=b.createDocumentFragment();return"undefined"==typeof a.cloneNode||"undefined"==typeof a.createDocumentFragment||"undefined"==typeof a.createElement}()}catch(c){j=!0,k=!0}}();var s={elements:m.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:l,shivCSS:m.shivCSS!==!1,supportsUnknownElements:k,shivMethods:m.shivMethods!==!1,type:"default",shivDocument:i,createElement:f,createDocumentFragment:g};a.html5=s,i(b)}(this,b),o._version=n,o._prefixes=x,o._domPrefixes=A,o._cssomPrefixes=z,o.mq=I,o.hasEvent=J,o.testProp=function(a){return h([a])},o.testAllProps=j,o.testStyles=H,o.prefixed=function(a,b,c){return b?j(a,b,c):j(a,"pfx")},q.className=q.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(p?" js "+F.join(" "):""),o}(this,this.document);function navActive(dropDown){var dropDownClass=$(dropDown).attr('class');if(dropDownClass.indexOf('active')==-1){$(dropDown).addClass('active')}else{$(dropDown).removeClass('active')}}
function rowSize(){var divRow=$('.content').children();$(window).bind('load resize',function(){if($(this).width()<=1009){divRow.removeClass('row');divRow.addClass('mobile-row')}else{divRow.addClass('row');divRow.removeClass('mobile-row')}})}
function changeLogo(staticEndpoint){$('.navi .top-bar-section .has-dropdown a.down').each(function(){var image=$(this).find('img')
$(this).hover(function(){image.attr('src',staticEndpoint+'static/img/menu/top/arrow.png')},function(){image.attr('src',staticEndpoint+'static/img/menu/top/arrow_black.png')})
$(this).next().find('li').each(function(){$(this).hover(function(){image.attr('src',staticEndpoint+'static/img/menu/top/arrow.png')},function(){image.attr('src',staticEndpoint+'static/img/menu/top/arrow_black.png')})})
$(this).click(function(){if(image.attr('src')==staticEndpoint+'static/img/menu/top/arrow.png'){image.attr('src',staticEndpoint+'static/img/menu/top/arrow_black.png')}else{image.attr('src',staticEndpoint+'static/img/menu/top/arrow.png')}})})
var logo=$('.top-bar .name h1 a img');if($(this).width()<=751){logo.attr('src',staticEndpoint+'static/img/menu/top/logo_2x.png');logo.attr('data-3x',staticEndpoint+'static/img/menu/top/logo_3x.png');}else{$('.navi .top-bar-section .has-dropdown a.down img').attr('src',staticEndpoint+'static/img/menu/top/arrow_black.png')
logo.attr('src',staticEndpoint+'static/img/menu/top/logo_mint_2x.png');logo.attr('data-3x',staticEndpoint+'static/img/menu/top/logo_mint_3x.png');}}
function imageHover(id,target){$(id).each(function(){$(this).hover(function(){$(this).find(target).show()},function(){$(this).find(target).hide()})})}